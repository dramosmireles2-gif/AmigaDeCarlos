...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  // No renderizar el sidebar en la página de login
      ...
      <aside className="w-60 bg-white border-r border-stone-100 flex flex-col fixed h-full z-40">
        ...
        <div className="p-3 border-t border-stone-100 space-y-0.5">
          ...
          <button
            ...
            className="w-full flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm text-stone-400 hover:bg-red-50 hover:text-red-600 transition-colors"
          >
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path strokeLinecap="round" strokeLinejoin="round" d="M8.25 9V5.25A2.25 2.25 0 0 1 10.5 3h6a2.25 2.25 0 0 1 2.25 2.25v13.5A2.25 2.25 0 0 1 16.5 21h-6a2.25 2.25 0 0 1-2.25-2.25V15M12 9l3 3m0 0-3 3m3-3H2.25" /></svg>
            Cerrar sesión
          </button>
        </div>
      </aside>
